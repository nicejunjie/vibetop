...
// Terrain codes
var T_GROUND = 0, T_ROCK = 1, T_ORE = 2, T_WATER = 3, T_CLIFF = 4, T_TREE = 5, T_ROAD = 6;
...
var T_RAMP = 7, T_BRIDGE = 8, T_GEM = 9, T_CIV = 10;
...
function oreT(t) { return t === T_ORE || t === T_GEM; }

function waterish(t) { return t === T_WATER || t === T_BRIDGE; }   // the deck reads as water to the shoreline
...
var MV_LAND = 0, MV_NAVAL = 1, MV_AMPH = 2;

function terrPass(t, mv) {
...
var WZ_DX = [1, -1, 0, 0, 1, 1, -1, -1], WZ_DY = [0, 0, 1, -1, 1, -1, 1, -1];

function buildableT(t) { return t === T_GROUND || t === T_ROAD; }  // never a ramp, a bridge deck or a civilian lot
...
var ME = P_HUMAN, FOE = P_AI;

function setSeat(p) { ME = p | 0; FOE = 1 - ME; }
...
function aiOf(g, p) { return p === P_AI ? g.ai : g.ai2; }

function isAiSide(g, p) { return !!aiOf(g, p); }

// The OTHER side index. Not a view question and not an AI one: a side flip.
function otherSide(p) { return p === P_HUMAN ? P_AI : P_HUMAN; }
...
var PAUSE_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="6.5" y="4.5" width="4.2" height="15" rx="1.2"/><rect x="13.3" y="4.5" width="4.2" height="15" rx="1.2"/></svg>';

var PLAY_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.5,4.6 L19,12 L7.5,19.4 Z"/></svg>';

var SND_ON_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5,9.2 L7.2,9.2 L12.2,5.0 L12.2,19.0 L7.2,14.8 L3.5,14.8 Z"/><path d="M14.6,8.6 A5.2,5.2 0 0 1 14.6,15.4" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/><path d="M17.0,6.0 A8.4,8.4 0 0 1 17.0,18.0" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/></svg>';

var SND_OFF_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5,9.2 L7.2,9.2 L12.2,5.0 L12.2,19.0 L7.2,14.8 L3.5,14.8 Z"/><path d="M15.0,9.4 L20.4,14.8 M20.4,9.4 L15.0,14.8" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/></svg>';
