// Iron Frontier — vehicles/rhino: the art for one unit.
...
export function drawRhino(C) {
  var PEDGE = C.PEDGE, RING = C.RING, a = C.a, barrel = C.barrel, bumper = C.bumper, by = C.by,
      ...
      plit = C.plit, prism = C.prism, puck = C.puck, px = C.px, py = C.py, sg = C.sg,
      tracks = C.tracks, wantH = C.wantH, wantT = C.wantT, wid = C.wid;
