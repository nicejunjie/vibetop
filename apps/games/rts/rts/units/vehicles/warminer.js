// Iron Frontier — vehicles/warminer: the art for one unit.
...
function drawWarminer(C) {
  var BIN = C.BIN, BIN_E = C.BIN_E, PEDGE = C.PEDGE, STEEL = C.STEEL, a = C.a, barrel = C.barrel,
      ...
      len = C.len, panel = C.panel, pdark = C.pdark, plit = C.plit, prism = C.prism, puck = C.puck,
      px = C.px, py = C.py, sg = C.sg, tracks = C.tracks, wid = C.wid;
