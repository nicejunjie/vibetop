...
prism(g, cx, baseY, ssHw, ssHh, ssLift, CONC, shade(CONC, 1.06), '#393939', 3);
// service door + louvres, house colour on the door only
facePatch(g, faceR, cx, baseY, ssHw, ssHh, ssLift, 0.30, 0.52, 0.05, 0.72, shade(col, 0.80), '#2c2c2c');
...
cylinder(g, cx + 2, ssRy - 2, 7, 12, STEEL, shade(STEEL, 1.2), '#373737');
...
g.strokeStyle = '#848484'; g.lineWidth = 1.4;
...
g.strokeStyle = '#4e4e4e'; g.lineWidth = 3;
