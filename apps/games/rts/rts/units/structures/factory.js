// ─── structures/factory ─── Iron Frontier unit art. Included into rts.html by tools/rts-build.py;
...
import { crates, cylinder, drums, floodlight } from '../../bake/vehicles.js';

export function drawFactory(C) {
  var AMB = C.AMB, AMBH = C.AMBH, DOP = C.DOP, HAZ = C.HAZ, baseY = C.baseY, bph = C.bph,
