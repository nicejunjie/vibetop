// ─── structures/reactor ─── Iron Frontier unit art. Included into rts.html by tools/rts-build.py;
...
import { cylinder, drums, prism } from '../../bake/vehicles.js';

export function drawReactor(C) {
