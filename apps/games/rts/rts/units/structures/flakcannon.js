// ─── structures/flakcannon ─── Iron Frontier unit art. Included into rts.html by tools/rts-build.py;
...
import { cylinder, gunAim, puckDrum } from '../../bake/vehicles.js';

export function drawFlakcannon(C) {
