// Iron Frontier — structures/tesla: the art for one unit.
...
export function drawTesla(C) {
  var baseY = C.baseY, bph = C.bph, col = C.col, cx = C.cx, dark = C.dark, fh = C.fh, fw = C.fw,
      g = C.g, hi = C.hi, lo = C.lo, plot = C.plot;
