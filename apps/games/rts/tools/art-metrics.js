...
const TARGETS = {
  ...
  'aspect.airOutsideRA2Band':    { want: 0,    dir: 'down', note: 'THE HARRIER WAS MEASURED AND LEFT AT 1.21, deliberately: its only lever is a wing() call SHARED WITH THE HORNET, and widening the span to bring the Harrier in (1.21 -> 0.90) drags the Hornet from 0.97 — the second most exact unit on the board — down to 0.81. Trading a correct unit for a marginal one is not a fix. The lever is also non-linear: span 11.4 -> 12.4 swings the aspect 1.96 -> 1.39, overshooting +21% to -14%, because the widest bearing flips. A Harrier-only fix needs its wing separated from the Hornet\'s first. || the same check for AIRCRAFT. The Nighthawk is 1.62 against RA2\'s 3.05 — the single worst offender on the whole board at 0.53 of reference, a helicopter drawn barely half as long as it should be' },
