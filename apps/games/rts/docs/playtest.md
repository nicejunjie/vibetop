...
`apps/games/rts/docs/roadmap.md` is followed by a playtest pass, and the findings go into
...
Each pass writes `apps/games/rts/docs/playtest-<date>.md`: a table of findings (severity,
scenario, repro, screenshot path) and the invariant violations. Everything
reproduced goes into `apps/games/rts/docs/roadmap.md` Phase 0 with a ☐.
