...
| `allied-ifv.png` | `File:CNCRA2 IFV Default.png` | 368x226 | Looked at. **EIGHT BEARINGS** of the missile-turret IFV on grass — the shape a rip should take, and the first real `[FV]` in this repo after `rts.html` cited a non-existent `allied-ifv-idle.png` for two passes. A row-width profile of the 3/4 bearing (mask `b >= g - 4`; blue-over-green separates it cleanly on grass) gives 45 rows total, launcher rows 4-18 = **33% of the height, 21 px of a 42 px width**, set BACK over the rear axles with the pale bonnet clear in front. Dark block, pale hull, one blue patch — the contrast, not the area, is why it reads |
| `allied-ifv-voxel.png` | `File:IFV Voxel Render.jpg` | 664x1272 | Looked at. The `[FV]` voxel in four views: a 6-wheeled pale APC under a chunky quad CELL launcher on a short pedestal. Settles the shape question the plate could not — the muzzles are square cell mouths in a grid, not long tubes, which `art.ini [FV] Weapon1FLH=64,48,180` says too (64 leptons forward against [GTNK]'s 150, and 180 UP) |
...
| `allied-mirage-tank.png` | `File:CNCRA2 Mirage Tank.png` | 381x216 | Looked at (2026-09-10). **EIGHT BEARINGS** on grass. A DARK navy tank with a BOX TURRET and a LONG THIN GUN — as long as the Grizzly's — and behind the turret a tall PALE UPRIGHT PANEL, the projector, as wide as the hull. This is the rip that overturned §2.3's "wide flat emitter housing and NO long gun" row: that row was written from a cameo and was wrong in both halves |
| `allied-prism-tank.png` | `File:CNCRA2 Prism Tank.png` | 400x269 | Looked at (2026-09-10). Eight bearings. A COMPACT tank — hull like the Grizzly's — carrying a SHORT pale mast with a bright blue-and-white prism head on top. Not a tower: the head is a small bright knob, and the whole unit is barely taller than a Mirage (59x43 against 59x39). Our 12.4-unit crystal column was 1.42x RA2's height |
| `allied-grizzly-tank.png` | `File:CNCRA2 Grizzly Battle Tank.png` | 324x219 | Looked at (2026-09-10). Eight bearings. A pale grey-blue tank, LOW, with a boxy turret and a LONG thin gun reaching well past the glacis; blue remap in two patches. The flattest thing on the ground, as §2.3 says — and the same broadside width as the Rhino, which is the size relationship this pass restored |
| `soviet-flak-track.png` | `File:RA2 Flak Track.png` | 290x212 | Looked at (2026-09-10). Eight bearings on snow. A khaki HALF-TRACK: truck cab and wheels forward, tracks aft, an open bed with a big silver flak gun raised at ~45 degrees on a red mount. Square (45x45) because the gun is raised, not because it is vertical — ours was near-vertical and 1.22x too tall |
| `soviet-tesla-tank.png` | `File:CNCRA2 Tesla Tank alpha appearance.png` | 310x237 | Looked at (2026-09-10). An in-game screenshot (alpha-era appearance, per the title) of four Tesla Tanks: LOW red-and-dark hulls with two SHORT silver coils standing forward. Used for the coil HEIGHT only — the coils are short, and ours were 1.34x too tall |
| `allied-chrono-miner.png` | `File:CNCRA2 Chrono Miner.png` | 299x218 | Looked at (2026-09-10). Eight bearings. A tracked truck with a big rounded blue grinder JAW at the nose, a blue cab, and a tan ore crate behind. Confirms the violet-drum-for-a-nose read and the crate; the drum is a large rounded mass, not a small one, which is why its height was restored after the height pass trimmed it |
| `soviet-war-miner.png` | `File:RA2 War Miner.png` | 328x225 | Looked at (2026-09-10). Eight bearings on snow. A big tan slatted ORE BIN on tracks, a red cab with a small GUN on top forward of the bin, a silver loader shovel at the nose. The tallest-aspect vehicle in the roster (56x48), so the bin stays tall and the turret rides clear of it |
| `soviet-tesla-tank-sheet.png` | `File:RA2 Tesla Tank.png` | 287x204 | Looked at (2026-09-10, 3x). **EIGHT BEARINGS** on snow. A LOW khaki tank with red owner blocks on the hull and, at the REAR, a raised red housing carrying two SHORT FAT SILVER coils — chrome drums, not tall copper masts. Replaced the alpha screenshot as the Tesla Tank reference; the coils moved aft and went silver on its say-so |
| `soviet-v3.png` | `File:RA2 V3 Rocket Launcher.png` | 316x244 | Looked at (2026-09-10, 3x). Eight bearings on snow. A tan six-wheeled truck, cab forward, with a long WHITE rocket (red nose, red tail fins) lying along the whole length at ~20 degrees on a red rail, nose past the cab. Ours had it at 45 degrees on an olive truck |
| `allied-mcv.png` | `File:CNCRA2 Allied MCV.png` | 304x225 | Looked at (2026-09-10) — and then looked at AGAIN at 5x after the user said the rebuild was worse: the first reading ("a long, low eight-wheeled truck with a blue cab") was taken from a segmented thumbnail and produced a flat slab. At 5x it is a TALL SEMI-TRUCK: a high boxy purple-grey cab at the nose, as tall as the body, then a flatbed carrying a big rounded deep-blue load with silver machinery at the tail, on three axles of large pale-hubbed wheels. 76x36 broadside, 66x46 diagonal — a bit bigger than a tank, not twice one |
| `allied-mcv-voxel.webp` | `File:Allied MCV Voxel Render.jpg` | 734x402 | Looked at (2026-09-11). Four voxel bearings on a blue key: the cab is short and tall with a raked nose, the folded blue equipment sits inside a silver saddle, the side rail has deep wheel-arch cutouts, and the rear carries pale transverse machinery with exposed cylinders. CDN-delivered WebP bytes are kept with the honest extension. Used for 3D construction and material separation; the gameplay sheet above remains the final silhouette reference. |
