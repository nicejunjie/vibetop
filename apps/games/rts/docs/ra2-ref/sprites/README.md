# RA2 sprite-rip verification notes

The complete roster is now in the [visual reference index](../index.html), with
its machine-readable audit generated by `tools/ra2-reference-library.js`. This
file preserves the detailed measurements and visual checks made while the
first references were assembled.
...
The exact-title and visual-inspection method below remains the rule for adding
or replacing a source.
