...
| `allied-mcv.png` | `File:CNCRA2 Allied MCV.png` | 304x225 | Looked at (2026-09-10). Eight bearings on sand. A LONG, LOW eight-wheeled truck with a blue cab and a segmented body — not a crane tower. RA2's [AMCV] is 69x47; ours was 96x81, the worst height error in the roster (1.50x), from a folded crane boom drawn at by-26.6 |
