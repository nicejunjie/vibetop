// Iron Frontier unit art — infantry/engineer
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/engineer` and
// `// @@END infantry/engineer` (one pair per @@PART below). Edit HERE, then
