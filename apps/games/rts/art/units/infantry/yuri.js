// Iron Frontier unit art — infantry/yuri
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/yuri` and
// `// @@END infantry/yuri` (one pair per @@PART below). Edit HERE, then
