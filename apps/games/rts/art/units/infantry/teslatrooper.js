// Iron Frontier unit art — infantry/teslatrooper
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/teslatrooper` and
// `// @@END infantry/teslatrooper` (one pair per @@PART below). Edit HERE, then
