// Iron Frontier unit art — infantry/cleg
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/cleg` and
// `// @@END infantry/cleg` (one pair per @@PART below). Edit HERE, then
