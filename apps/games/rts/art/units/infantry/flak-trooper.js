// Iron Frontier unit art — infantry/flak-trooper
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/flak-trooper` and
// `// @@END infantry/flak-trooper` (one pair per @@PART below). Edit HERE, then
