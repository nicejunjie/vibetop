// Iron Frontier unit art — infantry/conscript
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/conscript` and
// `// @@END infantry/conscript` (one pair per @@PART below). Edit HERE, then
