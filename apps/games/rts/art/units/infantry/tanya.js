// Iron Frontier unit art — infantry/tanya
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/tanya` and
// `// @@END infantry/tanya` (one pair per @@PART below). Edit HERE, then
