// Iron Frontier unit art — infantry/guardian-gi
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/guardian-gi` and
// `// @@END infantry/guardian-gi` (one pair per @@PART below). Edit HERE, then
