// Iron Frontier unit art — infantry/ivan
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART infantry/ivan` and
// `// @@END infantry/ivan` (one pair per @@PART below). Edit HERE, then
