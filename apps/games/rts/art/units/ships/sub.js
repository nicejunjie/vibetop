// Iron Frontier unit art — ships/sub
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART ships/sub` and
// `// @@END ships/sub` (one pair per @@PART below). Edit HERE, then
