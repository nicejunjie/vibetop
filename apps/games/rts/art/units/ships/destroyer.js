// Iron Frontier unit art — ships/destroyer
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART ships/destroyer` and
// `// @@END ships/destroyer` (one pair per @@PART below). Edit HERE, then
