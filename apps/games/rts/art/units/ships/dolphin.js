// Iron Frontier unit art — ships/dolphin
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART ships/dolphin` and
// `// @@END ships/dolphin` (one pair per @@PART below). Edit HERE, then
