// Iron Frontier unit art — aircraft/harrier
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART aircraft/harrier` and
// `// @@END aircraft/harrier` (one pair per @@PART below). Edit HERE, then
