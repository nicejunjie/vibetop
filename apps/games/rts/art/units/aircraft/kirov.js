// Iron Frontier unit art — aircraft/kirov
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART aircraft/kirov` and
// `// @@END aircraft/kirov` (one pair per @@PART below). Edit HERE, then
