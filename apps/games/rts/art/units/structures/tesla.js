// Iron Frontier unit art — structures/tesla
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/tesla` and
// `// @@END structures/tesla` (one pair per @@PART below). Edit HERE, then
