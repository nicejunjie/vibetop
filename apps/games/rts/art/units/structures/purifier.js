// Iron Frontier unit art — structures/purifier
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/purifier` and
// `// @@END structures/purifier` (one pair per @@PART below). Edit HERE, then
