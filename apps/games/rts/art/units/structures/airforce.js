// Iron Frontier unit art — structures/airforce
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/airforce` and
// `// @@END structures/airforce` (one pair per @@PART below). Edit HERE, then
