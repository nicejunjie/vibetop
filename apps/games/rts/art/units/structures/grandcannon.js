// Iron Frontier unit art — structures/grandcannon
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/grandcannon` and
// `// @@END structures/grandcannon` (one pair per @@PART below). Edit HERE, then
