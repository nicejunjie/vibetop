// Iron Frontier unit art — structures/psisensor
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/psisensor` and
// `// @@END structures/psisensor` (one pair per @@PART below). Edit HERE, then
