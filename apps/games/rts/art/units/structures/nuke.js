// Iron Frontier unit art — structures/nuke
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/nuke` and
// `// @@END structures/nuke` (one pair per @@PART below). Edit HERE, then
