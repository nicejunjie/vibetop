// Iron Frontier unit art — structures/refinery
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/refinery` and
// `// @@END structures/refinery` (one pair per @@PART below). Edit HERE, then
