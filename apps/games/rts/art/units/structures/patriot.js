// Iron Frontier unit art — structures/patriot
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/patriot` and
// `// @@END structures/patriot` (one pair per @@PART below). Edit HERE, then
