// Iron Frontier unit art — structures/gapgen
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/gapgen` and
// `// @@END structures/gapgen` (one pair per @@PART below). Edit HERE, then
