// Iron Frontier unit art — structures/spysat
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/spysat` and
// `// @@END structures/spysat` (one pair per @@PART below). Edit HERE, then
