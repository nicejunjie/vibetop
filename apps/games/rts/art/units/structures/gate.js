// Iron Frontier unit art — structures/gate
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/gate` and
// `// @@END structures/gate` (one pair per @@PART below). Edit HERE, then
...
// @@PART main — inside bakeGateSeg() in rts.html
