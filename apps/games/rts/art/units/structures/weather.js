// Iron Frontier unit art — structures/weather
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/weather` and
// `// @@END structures/weather` (one pair per @@PART below). Edit HERE, then
