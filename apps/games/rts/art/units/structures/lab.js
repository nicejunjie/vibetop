// Iron Frontier unit art — structures/lab
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/lab` and
// `// @@END structures/lab` (one pair per @@PART below). Edit HERE, then
