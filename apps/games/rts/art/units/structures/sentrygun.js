// Iron Frontier unit art — structures/sentrygun
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/sentrygun` and
// `// @@END structures/sentrygun` (one pair per @@PART below). Edit HERE, then
