// Iron Frontier unit art — structures/power
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART structures/power` and
// `// @@END structures/power` (one pair per @@PART below). Edit HERE, then
