// Iron Frontier unit art — vehicles/mcv
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/mcv` and
// `// @@END vehicles/mcv` (one pair per @@PART below). Edit HERE, then
