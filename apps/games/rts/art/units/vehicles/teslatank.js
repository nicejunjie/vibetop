// Iron Frontier unit art — vehicles/teslatank
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/teslatank` and
// `// @@END vehicles/teslatank` (one pair per @@PART below). Edit HERE, then
