// Iron Frontier unit art — vehicles/rhino
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/rhino` and
// `// @@END vehicles/rhino` (one pair per @@PART below). Edit HERE, then
