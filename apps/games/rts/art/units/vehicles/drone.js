// Iron Frontier unit art — vehicles/drone
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/drone` and
// `// @@END vehicles/drone` (one pair per @@PART below). Edit HERE, then
