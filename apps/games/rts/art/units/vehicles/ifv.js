// Iron Frontier unit art — vehicles/ifv
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/ifv` and
// `// @@END vehicles/ifv` (one pair per @@PART below). Edit HERE, then
