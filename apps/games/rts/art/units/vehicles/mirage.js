// Iron Frontier unit art — vehicles/mirage
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/mirage` and
// `// @@END vehicles/mirage` (one pair per @@PART below). Edit HERE, then
