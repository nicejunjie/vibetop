// Iron Frontier unit art — vehicles/v3
// Spliced VERBATIM into apps/games/rts/rts.html between `// @@ART vehicles/v3` and
// `// @@END vehicles/v3` (one pair per @@PART below). Edit HERE, then
