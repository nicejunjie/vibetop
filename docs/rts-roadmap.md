...
- ☐ Power plants, refineries, barracks, war factories, defences, the rest — same method (`docs/ra2-art-plan.md` §4, `aspect.py`, hue census, scene at zoom 1 and 2, build-up, damaged).
