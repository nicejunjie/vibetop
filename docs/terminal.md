...
A tabbed UI at `/terminals/` (`terminal/terminals.html`) manages terminal tabs with add (+), close (×, stops the service), drag-reorder, and double-click-to-rename.
